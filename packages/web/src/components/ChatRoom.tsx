...
export default function ChatRoom() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gray-900">
      ...
      {/* Message input */}
      <form onSubmit={handleSendMessage} className="flex-shrink-0 p-4 border-t border-gray-700 bg-gray-800">
        {/* File previews */}
        ...
        <div className="flex space-x-2">
          ...
          <input
            ...
            className="flex-1 px-4 py-2 bg-gray-700 border border-gray-600 rounded focus:outline-none focus:border-purple-500 text-white disabled:opacity-50"
          />
          <button
            type="submit"
